"""Framework adapter for the frozen Group A intraday-continuation signal."""
...
FEATURE_CONTRACT_HASH = "sha256:ed712e3f612ecf5f45a89f9f4977d693dfc64c1a006bf17a9a516349aa513190"
...
class Plugin:
    ...
    def metadata(self) -> StrategyMetadataV1:
        return StrategyMetadataV1(
            ...
            economic_hypothesis_id="NORMALIZED_INTRADAY_CONTINUATION",
        )
    ...
    def _decision(self, context: StrategyContextV1, config: StrategyConfigV1):
        ...
        try:
            threshold = _decimal_config(config, "momentum_threshold", "1.00")
        except ValueError:
            return NoTradeV1(primary_reason_code="FEATURE_SCHEMA_MISMATCH")
        ...
        if not candidates:
            ...
            return NoTradeV1(primary_reason_code="INTRADAY_CONTINUATION_GATE_NOT_MET")

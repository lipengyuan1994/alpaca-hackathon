...
- **EXECUTED 2026-08-31 — engine shipped, outcome runs still blocked (commit pending push):** deterministic pair-cell replay engine `packages/research_data/group_b_pair_cell.py` (986 lines) + feature layer `packages/research_data/group_b_features.py` + synthetic-fixture suite `tests/research_data/test_group_b_pair_cell.py` (20 tests, all passing; ruff E,F,I,B clean; full `tests/research_data` suite 47/47 green). Scope decisions recorded for Group C review:

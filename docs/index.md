...
|---|---|---|---|
| [`index.html`](index.html) | Public “Stable Income Generator” judge website with V13.5 research, SPY/QQQ comparison, five-minute paper evidence, recent system fills, system boundaries, and reproduction path | Judges, demo owner, submission reviewers | Public narrative; evidence labels and linked artifacts remain authoritative |
